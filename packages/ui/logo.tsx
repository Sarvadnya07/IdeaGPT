...
export function IdeaGPTMark({
  ...
  return (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="shieldGradPkg" x1="20" y1="15" x2="80" y2="85" gradientUnits="userSpaceOnUse">
            <stop offset="0%" stopColor="#00C29A" />
            <stop offset="50%" stopColor="#0284C7" />
            <stop offset="100%" stopColor="#3B82F6" />
          </linearGradient>
          <linearGradient id="outerGradPkg" x1="0" y1="0" x2="100" y2="100" gradientUnits="userSpaceOnUse">
