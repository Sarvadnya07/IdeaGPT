...
export default function ProjectOverviewPage({
  ...
  if (!project)
    return (
      <div className="py-20 text-center text-red-400">Project Not Found.</div>
    );
        ...
        <div className="space-y-6">
          <div className="bg-[#0b0b0d] border border-red-900/20 rounded-xl p-6">
            ...
            <p className="text-xs text-zinc-500 mb-4 leading-relaxed">
              Permanently delete this project and all associated AI analysis,
              reports, and roadmaps. This action cannot be undone.
            </p>
            <button
