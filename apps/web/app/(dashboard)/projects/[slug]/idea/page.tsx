...
export default function IdeaSubmissionPage() {
  ...
  const { ideaQuery, saveIdeaMutation, triggerEvaluationMutation } =
    useIdeaSubmission(projectId);
    ...
    <div className="max-w-4xl mx-auto py-8 px-4 space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <Link
            href="/dashboard"
            className="text-zinc-500 hover:text-white flex items-center gap-1 text-sm font-medium mb-4 transition-colors"
          >
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            disabled={
              triggerEvaluationMutation.isPending || saveIdeaMutation.isPending
            }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  handleChange("solution_description", e.target.value)
                }
        ...
        <section className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) =>
                handleChange("unique_selling_proposition", e.target.value)
              }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleChange("technology_stack", e.target.value)
                }
