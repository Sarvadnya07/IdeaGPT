...
export const roadmapsApi = {
  createRoadmap: (projectId: string, data: RoadmapCreate) =>
    api
      .post<Roadmap>(`/projects/${projectId}/roadmaps`, data)
      .then((res: AxiosResponse<Roadmap>) => res.data),

  getProjectRoadmaps: (projectId: string) =>
    api
      .get<Roadmap[]>(`/projects/${projectId}/roadmaps`)
      .then((res: AxiosResponse<Roadmap[]>) => res.data),

  getRoadmap: (roadmapId: string) =>
    api
      .get<Roadmap>(`/roadmaps/${roadmapId}`)
      .then((res: AxiosResponse<Roadmap>) => res.data),

  updateRoadmap: (roadmapId: string, data: Partial<RoadmapCreate>) =>
    api
      .patch<Roadmap>(`/roadmaps/${roadmapId}`, data)
      .then((res: AxiosResponse<Roadmap>) => res.data),
